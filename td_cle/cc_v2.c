...
int test_dessus_vide(int tab[largeur+2][hauteur+2]);
...
int main()
{
	...
	int possibilite_de_jouer = 1;
	
	
	
	while(score<score_max)
	{
		while(possibilite_de_jouer == 1)
		{
			dessine_plateau(etat);
			possibilite_de_jouer = test_dessus_vide(etat);
		}
