...
//variable d'augmentation du raon des cercles


//variable de detection de victoire par le joueur 1 ou 2

int v1=0;
int v2=0;

//variable du nuero de joueur (1 ou 2)
...
printf("afficher valeur de v1= %d \n", v1);
printf("afficher valeur de v2= %d \n", v2);

}

char le_joueur_1_a_gagne;
char le_joueur_2_a_gagne;
...
//write_char(le_joueur_1_a_gagne);
}

if(v2==1)
{
init_graphics(20,20);
//write_char(le_joueur_2_a_gagne);
}
