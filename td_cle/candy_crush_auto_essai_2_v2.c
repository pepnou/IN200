...
//			printf("(4) \n");
			for(case_x_2=1;case_x_2<largeur+1;case_x_2++)
			{
				...
				{
					for(case_x_3=1;case_x_3<largeur+1;case_x_3++)
					{
						printf("(3) \n");
						for(case_y_3=1;case_y_3<hauteur+1;case_y_3++)
						{
		...
		//								k++;
									...
									if((copie[case_x_3][case_y_3] != (-1)) && (k==2))
									{
										printf("(12) \n");
										sc = combo(copie,case_x_3,case_y_3);
										sc_temp = sc_temp + sc * (sc - 1);				
		//								k++;
									}
									k++;
